const globalParamsObject = {
    ...
    main: {
        adsCategory: ['Скидка', 'Благотворительность', 'Мероприятие', 'Объявление'],
        adsCategoryNames: ['sales', 'charity', 'events', 'avito'],
    ...
    charity: {},
    avito: {
        avitoCategory: ['Автотранспорт', 'Недвижимость снять', 'Недвижимость купить', 'Работа', 'Одежда и обувь', 'Хобби и отдых', 'Животные', 'Для бизнеса', 'Услуги', 'Электроника', 'Товары для дома и дачи'],
        avitoSubCategory: [
