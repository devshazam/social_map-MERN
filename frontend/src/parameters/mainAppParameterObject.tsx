const globalParamsObject = {
    ...
    avito: {
        ...
        avitoSubCategory: [
            ...
            ['Билеты и путешествия', 'Велосипеды', 'Коллекционирование', 'Охота и спорт'],
            ...
            ['Телефоны', 'Аудио и видео', 'Для Компьютеров', 'Игры, приставки и программы', 'Ноутбуки', 'Настольные Компьютеры', 'Фототехника', 'Планшеты и электронные книги', 'Оргтехника и расходники'],
