        ...
        <>
            <Row className="mb-3">
                <Col xs={12} md={6} className="wrap-image">
                    {adsItem ? (
                        <Image src={adsItem.image} id="goods-image" thumbnail />
                    ) : (
                ...
                <Col xs={12} lg={6}>
                    {adsItem && (
                        <h1>
                            {namesObject.adCategory}{" "}
                            {adCatArr[adsItem.adCategory - 1]}
                        </h1>
                    )}
                    {adsItem ? (
